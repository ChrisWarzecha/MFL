...
public class CustomSpellManager : MonoBehaviour
{
    public static CustomSpellManager current;
    ...
    {
        //spawn Spell prefab
        GameObject s = Instantiate(allSpells[spellIndex].prefab, pTransform.position + pTransform.forward * 15, Quaternion.identity);
